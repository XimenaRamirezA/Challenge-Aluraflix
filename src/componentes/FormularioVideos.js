            ...
            <Grid rowSpacing={5} container sx={{
              ...
              <Grid item xs={12}>
                ...
                <Controller
                  ...
                  control={control}
                  defaultValue=""
                  rules={{ required: 'El código de seguridad es requerido' }}
                  render={({ field }) => (
                    <div>
                      <TextField
                        {...field}
              ...
              <Grid item xs={12} direction="row" sx={{ display: 'flex', justifyContent: 'space-between' }} >
                ...
                <CategoriaButton onClick={iraCategoria}  sx={{ width: 200 }} variant="contained" size="large" >Nueva Categoría</CategoriaButton>
